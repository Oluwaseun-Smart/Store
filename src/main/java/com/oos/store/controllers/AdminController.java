...
public class AdminController implements Initializable {
    ...
    void handlePrintInvoice(ActionEvent event) {
        ...
        if (result.get() == ButtonType.OK) {
            ...
            if (Objects.nonNull(CashierUtils.listSales) && Objects.nonNull(CashierUtils.listGoods)) {
                try {
                ...
                alert3.setTitle("Sales is Empty ");
                alert3.setHeaderText("Empty");
                alert3.setContentText("Please select goods to be purchase!!!...");
                alert3.showAndWait();
            }
        }
    }
